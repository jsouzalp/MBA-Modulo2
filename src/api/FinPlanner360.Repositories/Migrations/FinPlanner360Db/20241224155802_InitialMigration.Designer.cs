...
namespace FinPlanner360.Repositories.Migrations.FinPlanner360Db
{
    ...
    [Migration("20241224155802_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Budgets.Budget", b =>
                {
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Categories.Category", b =>
                {
                    b.Property<Guid>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UniqueIdentifier")
            ...
            modelBuilder.Entity("FinPlanner360.Entities.GeneralBudgets.GeneralBudget", b =>
                {
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Transactions.Transaction", b =>
                {
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Users.User", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UniqueIdentifier")
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Budgets.Budget", b =>
                {
                    b.HasOne("FinPlanner360.Entities.Users.User", "User")
                        .WithMany("Budgets")
            ...
            modelBuilder.Entity("FinPlanner360.Entities.Transactions.Transaction", b =>
                {
                    b.HasOne("FinPlanner360.Entities.Categories.Category", "Category")
